...
@section('content')
<h1 class="h4 fw-bold mb-3">Edit Berita</h1>
<form action="{{ route('admin.posts.update',$post) }}" method="POST" enctype="multipart/form-data" class="card p-3 shadow-sm border-0">
@csrf @method('PUT')
<div class="row g-3">
  <div class="col-md-8"><label class="form-label">Judul *</label>
...
<div class="col-md-4">
  ...
  <div class="col-md-4">
    ...
    @if($post->cover)<img src="{{ asset('storage/'.$post->cover) }}" class="mt-2 rounded" style="width:180px;height:120px;object-fit:cover">@endif
  </div>
  ...
  <div class="col-12"><label class="form-label">Konten *</label>
