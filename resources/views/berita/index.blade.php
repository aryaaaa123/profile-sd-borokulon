...
<section class="container py-5">
  ...
  <div class="d-flex justify-content-between align-items-end flex-wrap gap-2">
    ...
    <form class="d-flex" role="search" action="{{ route('berita.index') }}" method="get">
      <input class="form-control me-2" type="search" name="q" placeholder="Cari berita..." value="{{ $q }}">
        ...
        <article class="card h-100 shadow-sm border-0 card-zoom">
          ...
          <div class="card-body d-flex flex-column">
            ...
            <h5 class="card-title truncate-2 mb-1">
              <a href="{{ route('berita.show', $p->slug) }}" class="stretched-link text-decoration-none text-dark">
                {{ $p->title }}
              </a>
            </h5>
            ...
            <small class="text-muted d-block mb-2">
              ...
              @if($p->author) &middot; <i class="bi bi-person me-1"></i>{{ $p->author }} @endif
            </small>
